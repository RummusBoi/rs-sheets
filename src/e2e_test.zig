...
const TestSelectedCell = struct {
    ...
    pub fn verifier(_: *const TestStep, app: *SpreadSheetApp) !void {
        ...
        std.testing.expectEqual(CellCoords{ .x = 4, .y = 4 }, app.selection_mode.SingleCell) catch |err| {
...
const TestMovingDuringEdit = struct {
    ...
    pub fn verifier(_: *const TestStep, app: *SpreadSheetApp) !void {
        ...
        std.testing.expectEqual(CellCoords{ .x = 5, .y = 6 }, app.selection_mode.SingleCell) catch |err| {
            std.debug.print("Expected selected cell to be set.\n", .{});
            return err;
        };
    }
...
const TestOutOfBoundKeyboard = struct {
    ...
    pub fn verifier(_: *const TestStep, app: *SpreadSheetApp) !void {
        ...
        std.testing.expectEqual(CellCoords{ .x = 0, .y = 0 }, app.selection_mode.SingleCell) catch |err| {
            std.debug.print("Expected selected cell to be set.\n", .{});
            return err;
        };
    }
...
const TestAreaSelectClearsCell = struct {
    ...
    pub fn verifier(_: *const TestStep, app: *SpreadSheetApp) !void {
        ...
        std.testing.expectEqual(Area{ .x = 1, .y = 1, .w = 5, .h = 5 }, app.selection_mode.Area) catch |err| {
...
const TestAreaSelectUpperLeft = struct {
    ...
    pub fn verifier(_: *const TestStep, app: *SpreadSheetApp) !void {
        ...
        std.testing.expectEqual(Area{ .x = 0, .y = 0, .w = -1, .h = -1 }, app.selection_mode.Area) catch |err| {
            std.debug.print("Expected selected area to be set.\n", .{});
            return err;
        };
    }
...
const TestSelectAreaBackspace = struct {
    ...
    pub fn verifier(_: *const TestStep, app: *SpreadSheetApp) !void {
        ...
        std.testing.expectEqual(Area{ .x = 5, .y = 10, .w = 2, .h = 2 }, app.selection_mode.Area) catch |err| {
            std.debug.print("Expected selected area to be set.\n", .{});
            return err;
        };
...
const TestSelectAreaBackspaceReverse = struct {
    ...
    pub fn verifier(_: *const TestStep, app: *SpreadSheetApp) !void {
        ...
        std.testing.expectEqual(Area{ .x = 6, .y = 11, .w = -2, .h = -2 }, app.selection_mode.Area) catch |err| {
...
const TestArrowAfterAreaSelect2 = struct {
    ...
    pub fn verifier(_: *const TestStep, app: *SpreadSheetApp) !void {
        ...
        std.testing.expectEqual(CellCoords{ .x = 1, .y = 2 }, app.selection_mode.SingleCell) catch |err| {
            std.debug.print("Expected selected cell to be set.\n", .{});
            return err;
        };
    }
...
const TestEnterAfterAreaSelect = struct {
    ...
    pub fn verifier(_: *const TestStep, app: *SpreadSheetApp) !void {
        ...
        std.testing.expectEqual(CellCoords{ .x = 5, .y = 5 }, app.selection_mode.SingleCell) catch |err| {
            std.debug.print("Expected selected cell to be set.\n", .{});
            return err;
        };
    }
...
const TestEnterAfterAreaSelect2 = struct {
    ...
    pub fn verifier(_: *const TestStep, app: *SpreadSheetApp) !void {
        ...
        std.testing.expectEqual(CellCoords{ .x = 1, .y = 1 }, app.selection_mode.SingleCell) catch |err| {
            std.debug.print("Expected selected cell to be set.\n", .{});
            return err;
        };
    }
...
const TestCopySelectedCell = struct {
    ...
    pub fn verifier(_: *const TestStep, app: *SpreadSheetApp) !void {
        ...
        std.testing.expectEqual(CellCoords{ .x = 2, .y = 2 }, app.selection_mode.SingleCell) catch |err| {
            std.debug.print("Expected selected cell to be set.\n", .{});
            return err;
        };
...
const TestCopyPasteSelectedCellNoEdit = struct {
    ...
    pub fn verifier(_: *const TestStep, app: *SpreadSheetApp) !void {
        ...
        std.testing.expectEqual(CellCoords{ .x = 3, .y = 2 }, app.selection_mode.SingleCell) catch |err| {
            std.debug.print("Expected selected cell to be set.\n", .{});
            return err;
        };
...
const TestCopyPasteArea = struct {
    ...
    pub fn verifier(_: *const TestStep, app: *SpreadSheetApp) !void {
        ...
        std.testing.expectEqual(Area{ .x = 2, .y = 5, .w = 2, .h = 4 }, app.selection_mode.Area) catch |err| {
            std.debug.print("Expected selected area to be set.\n", .{});
            return err;
        };
        // check that the paste wrote data
